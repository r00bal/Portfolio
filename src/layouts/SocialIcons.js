...
export default function SocialIcons({ color = 'black' }) {
  return (
    <Footer.IconWrapper>
      <Footer.IconLink href="https://github.com/r00bal?tab=repositories" color={color} hoverColor="var(--green-color)">
        <FontAwesomeIcon size="2x" icon={['fab', 'github']} title="github link" />
      </Footer.IconLink>
      <Footer.IconLink href="https://codepen.io/r00bal" color={color} hoverColor="var(--green-color)">
